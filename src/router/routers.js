...
export default [{
  ...
  },
  {
    ...
    children: [{
        ...
        component: () => import('@/view/content/team.vue')
      },
      {
        path: 'Companyprofile',
        name: '公司概况',
        ...
        component: () => import('@/view/content/Companyprofile.vue')
      },
      {
        path: 'news',
        name: '文章',
  ...
  },
  {
    ...
    children: [{
      ...
      },
      {
        ...
        component: () => import('@/view/argu-page/teamdetail.vue')
      },
      {
        path: 'query',
        name: 'articledetail',
        ...
        component: () => import('@/view/argu-page/articledetail.vue')
      },
      {
        path: 'query',
        name: 'Companydetail',
